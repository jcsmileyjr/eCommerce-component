...
const CartItem = ({pic, itemTitle, itemPrice, plateCount}) => {
    return(
            ...
            <div className='cartItem__details--container'>
                ...
                <div className='details--control-container'>
                    <div className='control--container'>
                        ...
                        <span className='control__arrow-container rightArrow'><img src={Arrow} className="cartItem__arrow--style" alt="" /></span>
                    </div>
